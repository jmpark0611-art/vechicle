...
const requiredText = [
  ...
  { file: path.join('app', '(tabs)', 'index.tsx'), text: '운행' },
  ...
  { file: path.join('app', '(tabs)', 'check.tsx'), text: 'OBD 차량 진단' },
