...
const requiredText = [
  ...
  { file: path.join('app', '(tabs)', 'check.tsx'), text: '차량운행시스템 점검' },
  ...
  { file: path.join('app', 'trips', '[id].tsx'), text: 'GPS 수집 구간' },
  { file: path.join('app', 'trips', '[id].tsx'), text: '좌표 샘플이 부족' },
  { file: path.join('app', 'trips', '[id].tsx'), text: '운행 경로 지도 열기' },
