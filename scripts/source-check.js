...
const requiredText = [
  ...
  { file: path.join('app', '(tabs)', 'check.tsx'), text: '누적 접속' },
  { file: path.join('lib', 'access-counter.ts'), text: 'increment_access_counter' },
  { file: path.join('docs', 'schema.sql'), text: 'app_access_counters' },
  ...
  { file: path.join('constants', 'theme.ts'), text: "tintColorLight = '#A8FF5F'" },
