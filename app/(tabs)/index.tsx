...
const styles = StyleSheet.create({
  ...
  activeTitle: { color: '#1E2946', fontSize: 36, fontWeight: '900' },
  heroIconBox: {
    width: 50,
    height: 50,
    borderRadius: 18,
  ...
  statCard: { flex: 1, minHeight: 78, borderRadius: 18, backgroundColor: '#F6F8FE', padding: 14 },
  statLabel: { color: '#7B86A8', fontSize: 12, fontWeight: '900', marginBottom: 7 },
  statValue: { color: '#1E2946', fontSize: 16, fontWeight: '900' },
  obdStrip: {
    minHeight: 52,
    borderRadius: 17,
  ...
  thanksTitle: { color: '#047857', fontSize: 22, fontWeight: '900' },
  thanksSub: { color: '#588674', fontSize: 14, fontWeight: '900', marginTop: 6, marginBottom: 12 },
  summaryLine: {
    flexDirection: 'row',
    alignItems: 'center',
    justifyContent: 'space-between',
  ...
  summaryKey: { color: '#588674', fontSize: 13, fontWeight: '900', flexShrink: 0 },
  summaryVal: { color: '#163B31', fontSize: 14, fontWeight: '900', flex: 1, textAlign: 'right' },
  obdStripLabel: { color: '#52607D', fontSize: 14, fontWeight: '900' },
  obdStripValue: { color: '#1D4ED8', fontSize: 14, fontWeight: '900', flexShrink: 1, textAlign: 'right' },
  input: {
    minHeight: 38,
    borderRadius: 13,
    borderWidth: 1,
  ...
  cancelBtnText: { color: '#52607D', fontSize: 16, fontWeight: '900' },
  endBtn: {
    flex: 1.4,
    minHeight: 58,
    borderRadius: 14,
  ...
  endBtnText: { color: '#FFFFFF', fontSize: 16, fontWeight: '900' },
  startBtn: {
    minHeight: 60,
    borderRadius: 19,
  ...
  startBtnText: { color: '#FFFFFF', fontSize: 18, fontWeight: '900' },
