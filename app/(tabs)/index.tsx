...
const styles = StyleSheet.create({
  ...
  statValue: { color: '#1E2946', fontSize: 18, fontWeight: '900' },
  obdStrip: {
    minHeight: 78,
    borderRadius: 20,
  ...
  autoOdoLabel: { color: '#7B86A8', fontSize: 14, fontWeight: '900', marginBottom: 8 },
  autoOdoValue: { color: '#1E2946', fontSize: 17, fontWeight: '900' },
  thanksCard: {
    flex: 1,
    borderRadius: 22,
