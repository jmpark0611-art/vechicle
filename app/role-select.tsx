...
const styles = StyleSheet.create({
  ...
  cardTitleRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: 10, marginBottom: 5 },
  cardTitle: { color: '#0F172A', fontSize: 17, fontWeight: '700', flexShrink: 0 },
  roleBadge: {
    color: '#2563EB',
    fontSize: 11,
    fontWeight: '700',
