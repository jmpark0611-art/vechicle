    ...
    <View style={[styles.screen, { paddingTop: insets.top + 14, paddingBottom: insets.bottom + 14 }]}>
      ...
      <Pressable style={styles.card} onPress={() => void chooseCommander()}>
        ...
        <View style={styles.cardCopy}>
          ...
          <Text style={styles.cardDesc}>관리자용 · 기록, 진단, 정비, 점검</Text>
        </View>
        <Text style={styles.cardChevron}>›</Text>
      </Pressable>
...
const styles = StyleSheet.create({
  ...
  eyebrow: { color: '#94A3B8', fontSize: 10, fontWeight: '600', marginBottom: 4, letterSpacing: 1.5, textTransform: 'uppercase' },
  title: { color: '#0F172A', fontSize: 20, fontWeight: '700', textAlign: 'center', marginTop: 2 },
  subtitle: { color: '#64748B', fontSize: 13, fontWeight: '400', textAlign: 'center', marginTop: 4 },
  unitCard: {
    backgroundColor: '#FFFFFF',
    borderRadius: 14,
    borderWidth: 1,
  ...
  unitLabel: { color: '#64748B', fontSize: 11, fontWeight: '600', marginBottom: 2 },
  unitValue: { color: '#0F172A', fontSize: 15, fontWeight: '700' },
  unitEditBtn: {
    minHeight: 28,
    borderRadius: 8,
  ...
  unitOptionText: { color: '#64748B', fontSize: 13, fontWeight: '600' },
  ...
  adminIcon: { backgroundColor: '#FFF7ED' },
  cardIconText: { fontSize: 20 },
  cardCopy: { flex: 1, minWidth: 0 },
  cardTitleRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: 10, marginBottom: 4 },
  cardTitle: { color: '#0F172A', fontSize: 16, fontWeight: '700', flexShrink: 0 },
  roleBadge: {
    color: '#2563EB',
    fontSize: 11,
    fontWeight: '700',
  ...
  cardDesc: { color: '#64748B', fontSize: 12, fontWeight: '400', lineHeight: 17 },
  cardChevron: { color: '#CBD5E1', fontSize: 26, fontWeight: '300', marginLeft: 6 },
});
